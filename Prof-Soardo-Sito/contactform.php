...
if (isset($_POST['email'])) {
  ...
  if(mail($to, $subject, $message, $headers)){
    $message = "Il tuo messaggio è stato ricevuto con successo";
   // header("Location :index.php?mailsend");
  } else {
    $message = "Messagio inviato errore";
...
if (isset($_POST['email'])) {
  $to = "prof.giorgiosoardo@gmail.com"; // receivers email
  $from = $_POST['email']; // this is the sender's Email address
  $nome = $_POST['nome'];
  $cognome = $_POST['cognome'];
  $email = $_POST['email'];
  ...
  ."Email: ".$email. "\n";
  //headers
  $headers = "From:www.profgiorgiosoardo.it";
